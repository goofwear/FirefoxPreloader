...
#define _WIN32_IE		0x0000	// We don't want any IE-specific functionality, this is for Firefox.
#define _WIN32_WINNT	0x0400	// We don't want any 2000 or greater functionality, this is for older machines.
