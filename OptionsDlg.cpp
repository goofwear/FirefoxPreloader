/////////////////////////////////////////////////////////////////////////////
// Options Dialog - FirefoxPreloaderDlg.cpp
/////////////////////////////////////////////////////////////////////////////
...
void COptionsDlg::OnBrowse() {
	...
	bi.lpszTitle = _T("Firefox Application Folder");
...
void COptionsDlg::OnOK() {
	CString			// String Variables
		szFFExe,	// Firefox.exe path
		szErrMsg;	// Error message resource
	HANDLE hFFExe;	// Firefox.exe CreateFile handle
...
BOOL COptionsDlg::OnInitDialog() {
	...
	// See if we can autofind Firefox
	if (::GetLatestFirefoxInstallDir(NULL)) {
