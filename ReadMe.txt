...
Note
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
It is recommended that you NOT use the "File->Exit" command to close Firefox or it's windows unless you are installing new extensions or themes. This will unload Firefox and defeat the purpose of this program.  Firefox can be closed via 'File->Close' or the X button on the windows' title bar
_________________________________________________________________
Known Issues
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
• The Preloader doesn't insure that the firefox.exe file it is using is the real one.  This may be fixed in a later version by check the exe against a list of checksums of known released versions.
_________________________________________________________________
Plans and ToDo(s)
¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯
1. Fix any remaining bugs... (this should always be a first in any software)
